...
const News = (props) => {
    ...
    useEffect(() => {
        document.title = `${capitalizeFirstLetter(props.category)} - NewsMonkeys`
        updateNews()
    ...
    return (
        <>
            ...
            {/* <div className="container d-flex justify-content-between">
                    <button disabled={state.page <= 1} onClick={handlePreviousClick} type="button" className="btn btn-dark"> &larr;Previous</button>
